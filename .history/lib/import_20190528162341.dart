...
* #Admin Route
*/
export 'routes/admin/admin_screen.dart';
export 'routes/admin/analytic_screen.dart';
export 'routes/admin/new_agent_screen.dart';
export 'routes/admin/new_campaign_screen.dart';
export 'routes/admin/new_template_screen.dart';
export 'routes/admin/select_agent_dialog.dart';

// #Agent
export 'routes/agent/agent_screen.dart';
export 'routes/agent/campaign_list_screen.dart';
export 'routes/agent/template_list_screen.dart';
export 'routes/agent/agent_analytic_screen.dart';
